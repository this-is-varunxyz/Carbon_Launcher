...
class AppsDrawerSheet extends StatelessWidget {
            ...
            builder: (context, favBox, _) {
              return ValueListenableBuilder(
                valueListenable: Hive.box<String>(
                  'settingsBox',
                ).listenable(keys: ['use_monochrome']),
                builder: (context, settingsBox, _) {
                  final useMonochrome =
                      settingsBox.get('use_monochrome', defaultValue: 'true') ==
                      'true';
                  ...
                  return BlocBuilder<AppCubit, AppState>(
                    builder: (context, state) {
                      ...
                      final totalItems =
                          1 + myApps.length + (showPlusButton ? 1 : 0);
                      ...
                      return GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                            ...
                            return _buildAppTile(
                              ...
                              onTap: () {
                                ...
                                showModalBottomSheet(
                                  ...
                                  builder: (_) => const CarbonSettingsSheet(),
                                );
                              },
                              onLongPress: () {},
                            );
                            ...
                            return _buildAppTile(
                              ...
                              onTap: () {
                                ...
                                showModalBottomSheet(
                                  ...
                                  isScrollControlled: true,
                                  backgroundColor: Colors.transparent,
                                  builder: (_) => const AppSelectionSheet(
                                    isSelectingFav: false,
                                  ),
                                );
                              },
                              onLongPress: () {},
                          ...
                          return _buildAppTile(
                            iconBytes: app.icon,
                            letterFallback: app.name.isNotEmpty
                                ? app.name[0].toUpperCase()
                                : '?',
                            label: app.name,
                            useMonochrome: useMonochrome,
                            onTap: () => context.read<AppCubit>().launchApp(
                              app.packageName,
                            ),
  ...
  Widget _buildIconContent(
    ...
    if (iconData != null) {
      ...
      final img = Image.memory(iconBytes, width: 32, height: 32);
      if (useMonochrome) {
        return ColorFiltered(colorFilter: greyscaleFilter, child: img);
      }
      return img;
    } else {
      return Text(
